...
class JournalSection extends React.Component {
  render() {
    const hasOtherNames = this.props.location && this.props.location.otherNames && this.props.location.otherNames.size > 0;
      ...
      <div className={classNames("JournalSection", {
        ...
        <div className="JournalSection__text">
          {this.props.location && <h3 className="JournalSection__location-label">
            ...
            {hasOtherNames && <small className="JournalSection__location-other-names">
              {otherNames}
            </small>}
          </h3>}
          {this.props.children}
